...
- [2.4 Gestos Multiponto (uso simultâneo de vários dedos) ou gestos baseados no desenho de uma trajetória estão também disponíveis com gestos que fazem uso do toque de um só ponto ou que não obrigam a desenhar uma trajetória)](24.md)
...
- [4.1 Teclado virtual definido para o tipo de entrada de dados](41.md)
- [4.2 Métodos de entrada de dados simples e previsíveis](42.md)
- [4.3 Suporte a teclados e outros dispositivos de entrada, alternativos ao ecrã sensível ao toque](43.md)
...
- [8.1 Conteúdo gráfico tem um alternativo em texto acessível](81.md)
- [8.2 Vídeos contêm legendas sincronizadas e sem erros](82.md)
- [8.3 Vídeos contêm transcrições em texto e, se necessário, também dispõem de áudiodescrição](83.md)
- [8.4 Textos e não imagens de texto são usados sempre que possível](84.md)
